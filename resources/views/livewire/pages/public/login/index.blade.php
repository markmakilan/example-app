<div class="h-screen flex divide-x">
    ...
    <div class="w-full md:w-[500px] flex items-center justify-center p-4">
        ...
        <form wire:submit="login" class="w-[400px] space-y-4">
            <div class="space-y-2">
                <h1 class="text-accent text-3xl font-bold">Login</h1>
                <p class="text-sm">Enter your email below to login to your account.</p>
            </div>
            ...
            <div class="flex items-center justify-between">
                <x-button.primary type="submit" target="login">
