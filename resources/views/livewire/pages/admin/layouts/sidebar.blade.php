<div class="w-64 h-full group/toggle-button" x-show="sidebar">
    <div class="flex flex-col h-full divide-y">
        <div class="h-12 flex items-center relative">
            <button class="absolute hidden group/sidebar-toggle rounded-sm p-1 -right-[12.5px] hover:bg-secondary group-hover/toggle-button:block" x-on:click="toggleSidebar">
